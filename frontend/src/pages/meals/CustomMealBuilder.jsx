...
const CustomMealBuilder = () => {
  ...
  const { loading: mealLoading, error: mealError } = useSelector(
    (state) => state.meals
  );
  ...
  if (restaurantError || mealError) {
    return (
      <div className="alert alert-danger">{restaurantError || mealError}</div>
    );
  }

  if (!currentRestaurant) {
    return <div className="alert alert-warning">Restaurant not found.</div>;
  }
  ...
  return (
    <div className="custom-meal-builder">
      ...
      <p>
        Select ingredients from {currentRestaurant.name} to create your perfect
        meal.
      </p>
              ...
              {availableIngredients
                ...
                .map((ingredient) => (
                  <div key={ingredient.id} className="ingredient-item">
                    ...
                    <p>
                      <strong>Price:</strong> ${ingredient.price_per_unit} per{" "}
                      {ingredient.unit}
                    </p>
      ...
      >
        ...
        <button
          ...
          disabled={
            selectedIngredients.length === 0 || !mealName.trim() || mealLoading
          }
        >
