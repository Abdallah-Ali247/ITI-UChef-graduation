...
const CustomMealCreator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (createCustomMeal.fulfilled.match(resultAction)) {
        ...
        const addToCartConfirm = window.confirm(
          "Would you like to add this custom meal to your cart?"
        );
  ...
  if (mealError || ingredientsError) {
    return (
      <div className="alert alert-danger">{mealError || ingredientsError}</div>
    );
  }
  ...
  return (
    <div className="custom-meal-creator">
      ...
      <p>
        Customize <strong>{currentMeal.name}</strong> to your liking
      </p>
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center" }}>
                      ...
                      <div>
                        ...
                        <p>
                          <strong>${currentMeal.price.toFixed(2)}</strong>
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      {selectedIngredients.map((ingredient) => (
                        ...
                        >
                          <div>
                            ...
                            <p>
                              <small>${ingredient.price} each</small>
                            </p>
