      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem', marginTop: '2rem' }}>
        <div className="checkout-form">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label htmlFor="delivery_notes" className="form-label">Delivery Notes (Optional)</label>
              <textarea
                id="delivery_notes"
                name="delivery_notes"
            ...
            {payment_method !== 'cash' && (
              <div className="alert alert-info">
                Note: For this demo, no actual payment will be processed. In a production environment, this would connect to a payment gateway.
              </div>
            )}
